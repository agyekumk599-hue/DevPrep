        ...
        startTimer() {
          ...
          const updateTimerDisplay = () => {
            if (this.state.timer <= 0) {
              ...
              alert("Time is up! Exam is being submitted automatically.");
            ...
            display.innerHTML = `<i class="fa-regular fa-clock"></i> <span>${m}:${s}</span>`;
        ...
        submitExam(auto = false) {
          if (!auto) {
            ...
            if (answered < totalQuestions) {
              document.getElementById("confirm-answered").textContent =
                answered;
